...
@Slf4j
public class MockConsoleServer extends ExternalResource {

    private final MockWebServer server = new MockWebServer();

    private boolean isStarted;

    public MockConsoleServer() throws MalformedURLException {
        startup();
    }
    ...
    public void startup() throws MalformedURLException {
        ...
        try {
            server.start();
            log.info("Search server is started at port " + getPort());
        } catch (IOException e) {
            e.printStackTrace();
