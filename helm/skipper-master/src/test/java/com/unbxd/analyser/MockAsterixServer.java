...
@Slf4j
public class MockAsterixServer extends ExternalResource {

    private final MockWebServer server = new MockWebServer();

    private boolean isStarted;

    public MockAsterixServer() throws MalformedURLException {
        startup();
    }
    ...
    public void startup() throws MalformedURLException {
        ...
        try {
            server.start();
            log.info("Asterix server is started at port " + getPort());
        } catch (IOException e) {
            e.printStackTrace();
