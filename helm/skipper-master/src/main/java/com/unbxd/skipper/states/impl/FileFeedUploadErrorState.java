...
@Log4j2
public class FileFeedUploadErrorState extends ErrorVirtualServeState {
    ...
    @Override
    public ServeStateType getStateType() { return FILE_FEED_UPLOAD_ERROR; }

    @Override
    @JsonIgnore
    public ServeStateType getPrevStateType() { return FILE_FEED_UPLOAD; }
