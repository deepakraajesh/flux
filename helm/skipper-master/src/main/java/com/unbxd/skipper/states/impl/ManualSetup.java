...
@Log4j2
public class ManualSetup extends VirtualServeState {

    private static final ServeStateType[] previousStates = {SETUP_SEARCH, AI_SETUP, MANUAL_SETUP};
    @Override
    ...
    public ServeStateType getStateType() {
        return ServeStateType.MANUAL_SETUP;
    }
