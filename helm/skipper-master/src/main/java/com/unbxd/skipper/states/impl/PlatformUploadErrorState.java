...
@Log4j2
public class PlatformUploadErrorState extends ErrorVirtualServeState {
    ...
    @Override
    public ServeStateType getStateType() { return PLATFORM_UPLOAD_ERROR; }

    @Override
    @JsonIgnore
    public ServeStateType getPrevStateType() { return PLATFORM_UPLOAD; }
