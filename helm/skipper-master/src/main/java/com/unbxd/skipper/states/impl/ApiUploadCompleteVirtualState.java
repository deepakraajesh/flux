...
import static com.unbxd.skipper.states.model.ServeStateType.API_UPLOAD_COMPLETE;

@Log4j2
public class ApiUploadCompleteVirtualState extends VirtualServeState {

    @Override
    public ServeStateType getPrevStateType() { return ServeStateType.API_UPLOAD; }
    ...
    @Override
    public ServeStateType getStateType() { return API_UPLOAD_COMPLETE; }
